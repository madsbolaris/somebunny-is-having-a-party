# Theme Analysis — Finneas, Ace Archer · "Somebunny's on the Menu" (B4)

> *Everybunny came for dinner.* A **Selesnya (G/W) Food-and-tokens** feast with a secret on the menu: the guests are the ingredients. Everyone brings a dish (**Food tokens**), every guest at the table is fattened up (**+1/+1 counters** and lifegain), and the ones sent through the kitchen come back as provisions. Built on the two-pillar core — **Finneas, Ace Archer** and **Heliod, Sun-Crowned** — and it ends when the Cordyceps Rat King takes his seat at the head of the table.

## Why the feast *is* the engine

In this shell, **a Food is 3 stored life on demand — and this deck turns life into power** (the guests never notice they're being fattened up):
...
|------|----------|-------|-------|------|
| Finneas, Ace Archer | [🔗](https://scryfall.com/card/blb/348) | ✅ |  | Commander. Each attack drops a +1/+1 counter on every token and Rabbit you control, then draws once your board tops power 10 — the host at the head of the table, fattening every guest and counting how many have come to dinner. |

## The Base Core — borderless & foil

| Card | Scryfall | Core? | Food? | Role |
|------|----------|-------|-------|------|
| Kitchen Finks | [🔗](https://scryfall.com/card/uma/216) | ✅ |  | The guest who came to dinner and won't leave: gains 2 life on the way in (a Heliod counter) on a 3/2 body that shrugs off removal via persist. With **Heliod** and a free sac outlet (**Ashnod's Altar**) the persist loops forever — infinite life and ETB triggers, which Archangel of Thune or Cathars' Crusade turn into the win. |
| Heliod, Sun-Crowned | [🔗](https://scryfall.com/card/cmm/29) | ✅ |  | Indestructible engine presiding over the feast: every point of life you gain (crack a Food, gain 3) becomes a +1/+1 counter, fattening the guests course by course. Also the engine behind the Spike Feeder + Archangel infinite. |
...
| Birds of Paradise | [🔗](https://scryfall.com/card/msc/170) |  |  | Any-color turn-one dork — and a body Finneas can counter up. |
| Cultivate | [🔗](https://scryfall.com/card/plst/LCC-235) |  |  | Ramp two and fix — a basic to the battlefield (a landfall trigger for Tireless Provisioner) and one to hand; reliable acceleration that never cares which lands you draw. |
| Crop Rotation | [🔗](https://scryfall.com/card/plst/DDR-7) |  |  | One mana, sacrifice a land: tutor any land onto the battlefield — Gaea's Cradle, Boseiju, or a dual on demand. |
| Smothering Tithe | [🔗](https://scryfall.com/card/cmm/57) |  |  | Taxes every opponent's draw into Treasure — snowballs your mana all game. |
| Selesnya Signet | [🔗](https://scryfall.com/card/tdc/324) |  |  | A two-mana rock that fixes into {G}{W} every turn — smooths the curve and never misses a color. |
...
## Sacrifice Outlets — feed the Ozolith
...
| Card | Scryfall | Core? | Food? | Role |
|------|----------|-------|-------|------|
| Doubling Season | [🔗](https://scryfall.com/card/fdn/216) | ✅ |  | Doubles your tokens, your Food, AND your +1/+1 counters — the whole spread twice over. |
| Anointed Procession | [🔗](https://scryfall.com/card/akh/2) |  |  | The white half of the token doublers — twice the guests and twice the Food. |
...
| Resourceful Defense | [🔗](https://scryfall.com/card/eoc/67) |  |  | A second Ozolith on an enchantment: when a counter-laden permanent leaves, move its counters onto another, and pay {4}{W} to relocate counters at will — redundancy for the Ozolith effect. |
| Byrke, Long Ear of the Law | [🔗](https://scryfall.com/card/blb/380) |  |  | A Rabbit that keeps the authorities looking elsewhere: doubles the counters on your attackers, and can bounce a big threat with those counters. |

## Lifegain — the Heliod loop

| Card | Scryfall | Core? | Food? | Role |
|------|----------|-------|-------|------|
| Archangel of Thune | [🔗](https://scryfall.com/card/sld/1337) | ✅ |  | Rises over the table and gives the final blessing: every point of lifegain pumps your whole board +1/+1, so every guest still seated swells with rude, roaring health — with a wide lifelink crowd and a table full of Food it ends games. |
| Ocelot Pride | [🔗](https://scryfall.com/card/mh3/38) | ✅ |  | The guest who came to *eat*, not be eaten — a first-striking, lifelinking cat padding between the tables. Because the kitchen bleeds a little life every turn, each end step she conjures another Cat; and once the feast is crowded enough for the city's blessing, she copies every token that arrived that turn — doubling the Cats, the Food, and the Clues in one greedy sweep. |
| Ajani, Strength of the Pride | [🔗](https://scryfall.com/card/m20/2) |  |  | Guards the door: gains life equal to your creatures, makes a Pridemate (lifegain → counter), and once you're 15 life ahead, exiles every opponent's creature and artifact. |
...
| Card | Scryfall | Core? | Food? | Role |
|------|----------|-------|-------|------|
| Sylvan Library | [🔗](https://scryfall.com/card/dmr/179) |  |  | Premium card selection that keeps the party from running dry. |
| The Great Henge | [🔗](https://scryfall.com/card/cmm/294) | ✅ |  | Cheap once a big creature's out; every creature that enters draws a card, adds a +1/+1 counter, and gains life — pure engine. |
...
| Card | Scryfall | Core? | Food? | Role |
|------|----------|-------|-------|------|
| Heroic Intervention | [🔗](https://scryfall.com/card/ltc/249) |  |  | Shrugs the whole board off destruction and targeting for two mana. |
| Teferi's Protection | [🔗](https://scryfall.com/card/2x2/32) |  |  | Phases the party out for a turn — wipes and alpha strikes whiff. |
| Flawless Maneuver | [🔗](https://scryfall.com/card/cmm/24) |  |  | Free board-wide indestructible when your commander's out. |
| Lightning Greaves | [🔗](https://scryfall.com/card/sld/99) |  |  | Haste and shroud for a {0} equip — Finneas swings the turn he lands and shrugs off targeted removal, and it re-equips free to guard your next threat. |
| Grand Abolisher | [🔗](https://scryfall.com/card/cmm/27) |  |  | The maître d' who lets nothing interrupt dinner service — on your turn, opponents can't cast spells or activate abilities, so the combo assembles and fires with zero response. The G/W answer to "they'll just counter it." |
| Silence | [🔗](https://scryfall.com/card/m14/35) |  |  | A hush falls over the hall — opponents can't cast spells for the rest of the turn. Lead the combo turn with it and every held-up answer is stranded in hand. |
...
| Worldly Tutor | [🔗](https://scryfall.com/card/dmr/185/worldly-tutor) |  |  | A quiet word to the kitchen — set any creature on top of the deck for one mana, so the next course is exactly the guest the plan needs. Shares the DMR frame with Enlightened Tutor. |

## Lands

| Card | Scryfall | Core? | Food? | Role |
|------|----------|-------|-------|------|
| Command Tower | [🔗](https://scryfall.com/card/ecc/59) |  |  | Perfect two-color fixing. |
| Command Beacon | [🔗](https://scryfall.com/card/tdc/352) |  |  | Sacrifice it to put Finneas from the command zone into your hand — recast at base cost and ignore the commander tax entirely. |
| Temple Garden | [🔗](https://scryfall.com/card/ecl/268) |  |  | Untapped G/W dual. |
| Savannah | [🔗](https://scryfall.com/card/3ed/285) |  |  | The original untapped G/W dual. |
| Sunpetal Grove | [🔗](https://scryfall.com/card/fic/432) |  |  | G/W check land. |
| Brushland | [🔗](https://scryfall.com/card/ltc/297) |  |  | Painland fixing, always untapped. |
| Horizon Canopy | [🔗](https://scryfall.com/card/ima/240) |  |  | G/W fixing that cashes in for a card late. |
| Wooded Bastion | [🔗](https://scryfall.com/card/plst/2XM-332) |  |  | Filter land for double-pip turns. |
| Bountiful Promenade | [🔗](https://scryfall.com/card/msc/226) |  |  | **Sideboard (1v1 focus)** — enters tapped with fewer than two opponents; an untapped G/W dual in a multiplayer pod. |
| Hushwood Verge | [🔗](https://scryfall.com/card/dsk/261) |  |  | An effectively untapped G/W dual — you'll always control a Forest or Plains to turn on the white side. |
| Branchloft Pathway | [🔗](https://scryfall.com/card/znr/258) |  |  | Pick your color — flexible untapped fixing. |
| Reflecting Pool | [🔗](https://scryfall.com/card/clb/358) |  |  | Any-color fixing off your board. |
